...
/**
 * Certificate-frame dialog for transaction / simulation failures.
 * Title + summary + fix in operator language; full log collapsed by default.
 */
export function ErrorModal({
  ...
  useEffect(() => {
    ...
    // Focus primary dismiss control for keyboard users.
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="space-y-4 px-6 py-5">
          <p
            id={`${titleId}-summary`}
            className="text-sm leading-[1.55] text-foreground"
          >
            {error.summary}
          </p>
