...
export function resolveFixedValue(
  field: FieldDef,
  network: Network,
): string | undefined {
...
export const VIEW_FUNCTIONS: FunctionDef[] = [
  {
    ...
    title: "Vault State",
    description:
      "Read a vault account: shares, TVL, pending balances, deposit/redeem fees, asset count.",
  ...
  },
  {
    ...
    fields: [
      VAULT_ID_FIELD,
      {
        name: "fee_recipient",
        label: "Fee recipient",
        placeholder: ADMIN_PUBKEY.toBase58(),
      },
    ],
